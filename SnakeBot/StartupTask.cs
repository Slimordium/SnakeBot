...
namespace SnakeBot
{
    public sealed class StartupTask : IBackgroundTask
    {
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            _display = new SparkFunSerial16X2Lcd(); //LCD Display that will show usefull debug messages
            ...
            _ntripClient = new NtripClient("172.16.0.226", 8000, "", "", "", _display); //The counter part to this, is the RtkGpsBase code. The RtkGpsBase code runs on a seperate PI and just serves up GPS correction data. Of course this IP will probably change.
